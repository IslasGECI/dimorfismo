...
La  \texttt{tabla\_mejores\_modelos.csv} muestra los valores estimados de las diferentes morfometrías:

\begin{table}[ht]
    \centering
    \caption{Variables predictoras para principales componenetes de análisis de ($n$=135) albatros Laysan en Isla Guadalupe desde 2014-2018.}
    \bigskip
...
\begin{table}[h]
    \centering
    \caption{Variables predictoras obtenidas después de la normalizacion según la ecuación (\ref{normalizacion}) para principales componenetes de análisis de ($n$=135) albatros Laysan en Isla Guadalupe desde 2014-2018.}
    \bigskip
    \renewcommand{\arraystretch}{1.3}
