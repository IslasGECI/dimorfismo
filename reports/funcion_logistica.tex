...
\begin{table}[h]
    ...
    \end{tabular}
    \label{modeloLogistico}
    \caption{Comparación entre hombres( \textsl{n} =61) y mujeres ( \textsl{n} =74) Albatros de Laysan en Isla Guadalupe durante 2014-2018 para todas las variables morfoloficas. }
\end{table}
...
\begin{table}[htbp]
    ...
    \caption{Comparación de resultados obtenidos después de la normalizacion según la ecuación (\ref{normalizacion}) aplicada a las variables morfoloficas de Albatros Laysan. }
\end{table}
